...
export const DEFAULT_TACTICS_WINDOW_START_SECONDS = 13;
export const DEFAULT_TACTICS_WINDOW_END_SECONDS = 14;
export const DEFAULT_TACTICS_T_WINDOW_START_SECONDS = DEFAULT_TACTICS_WINDOW_START_SECONDS;
export const DEFAULT_TACTICS_T_WINDOW_END_SECONDS = DEFAULT_TACTICS_WINDOW_END_SECONDS;
export const DEFAULT_TACTICS_CT_WINDOW_START_SECONDS = DEFAULT_TACTICS_WINDOW_START_SECONDS;
export const DEFAULT_TACTICS_CT_WINDOW_END_SECONDS = DEFAULT_TACTICS_WINDOW_END_SECONDS;

...
export const defaultSettings: Settings = {
  ...
  analyze: {
    ...
    defaultTacticsWindowStartSeconds: DEFAULT_TACTICS_WINDOW_START_SECONDS,
    defaultTacticsWindowEndSeconds: DEFAULT_TACTICS_WINDOW_END_SECONDS,
  },
  playback: {
    width: 1024,
    height: 768,
  ...
  download: {
    ...
    downloadPerfectWorldDemosAtStartup: false,
    downloadPerfectWorldDemosInBackground: false,
  },
  matches: {
    gameModes: [],
    demoTypes: [],

...
const v14: Migration = {
  ...
  run: async (transaction) => {
    await transaction.schema
      .createTable('team_tactics_player_positions')
      .ifNotExists()
      .addColumn('id', 'bigserial', (col) => col.primaryKey().notNull())
      .addColumn('match_checksum', 'varchar', (col) => col.notNull())
      .addForeignKeyConstraint(
        'team_tactics_player_positions_match_checksum_fk',
        ['match_checksum'],
        'matches',
        ['checksum'],
    ...
    await transaction.schema
      .createIndex('team_tactics_player_positions_match_checksum_round_number_idx')
      .ifNotExists()
      .on('team_tactics_player_positions')

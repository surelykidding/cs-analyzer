...
export const RendererClientMessageName = {
  ...
  FetchTeamTactics: 'fetch-team-tactics',
  ...
  GenerateMatchPistolRoundPositions: 'generate-match-pistol-round-positions',
  GenerateMatchTacticsPositions: 'generate-match-tactics-positions',
  ...
  StartFaceitScoutingSession: 'start-faceit-scouting-session',
  FetchCurrentFaceitScoutingSession: 'fetch-current-faceit-scouting-session',
  FetchFaceitScoutingTactics: 'fetch-faceit-scouting-tactics',
  DeleteFaceitScoutingSession: 'delete-faceit-scouting-session',
  ...
  Start5EPlayScoutingSession: 'start-5eplay-scouting-session',
  FetchCurrent5EPlayScoutingSession: 'fetch-current-5eplay-scouting-session',
  Fetch5EPlayScoutingTactics: 'fetch-5eplay-scouting-tactics',
  Delete5EPlayScoutingSession: 'delete-5eplay-scouting-session',
  SendPerfectWorldSmsCode: 'send-perfect-world-sms-code',
  FetchPerfectWorldAccounts: 'fetch-perfect-world-accounts',
  ValidatePerfectWorldAccount: 'validate-perfect-world-account',
  FetchLastPerfectWorldMatches: 'fetch-last-perfect-world-matches',
  AddPerfectWorldAccount: 'add-perfect-world-account',
  ImportPerfectWorldClientAccount: 'import-perfect-world-client-account',
  DeletePerfectWorldAccount: 'delete-perfect-world-account',
  UpdateCurrentPerfectWorldAccount: 'update-current-perfect-world-account',
  StartPerfectWorldScoutingSession: 'start-perfect-world-scouting-session',
  FetchCurrentPerfectWorldScoutingSession: 'fetch-current-perfect-world-scouting-session',
  FetchPerfectWorldScoutingTactics: 'fetch-perfect-world-scouting-tactics',
  DeletePerfectWorldScoutingSession: 'delete-perfect-world-scouting-session',
